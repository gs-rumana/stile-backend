...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/gursahb/Projects/Personal/Stile/backend/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/gursahb/Projects/Personal/Stile/backend/public/storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'showLogin','login','dashboard',
'categories.index','categories.create','categories.store','categories.show','categories.edit',
'categories.update','categories.destroy','sub-categories.index','sub-categories.create','sub-categories.store',
'sub-categories.show','sub-categories.edit','sub-categories.update','sub-categories.destroy','subCategoriesOfCategory',
'products.index','products.create','products.store','products.show','products.edit',
'products.update','products.destroy','storage.local',);
        registerArgumentsSet('views', 
'auth.login','components.dashboard.file-input','components.dashboard.insight-card','components.dashboard.navbar','components.dashboard.sidebar',
'errors.404','home','layouts.dashboard','pages.dashboard.categories.create','pages.dashboard.categories.index',
'pages.dashboard.index','pages.dashboard.products.create','pages.dashboard.products.edit','pages.dashboard.products.index','pages.dashboard.products.show',
'pages.dashboard.sub-categories.create','pages.dashboard.sub-categories.index','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
